        ...
        <ul class="navbar-nav float-left mr-auto ml-3 pl-1">
            <li class="nav-item d-none d-md-block">
                <a class="nav-link" href="javascript:void(0)">
                    <div id="clock" style="font-family: Raleway,Rubik,sans-serif;font-size:15px;font-weight:500;text-shadow:0px 0px 1px #fff;color:#212529;"></div>
                </a>
            </li>
            <li class="nav-item d-none d-md-block">
                <a class="nav-link" href="javascript:void(0)">
                    <div id="date" style=" letter-spacing:3px;font-size:15px;font-weight:500;font-family:Raleway,Rubik,sans-serif;color:#212529;"></div>
                </a>
            </li>
        </ul>
