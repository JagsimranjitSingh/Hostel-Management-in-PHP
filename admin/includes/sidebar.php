...
<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="parcel.php" aria-expanded="false"><i class="fas fa-box-open"></i><span class="hide-menu">Parcel Management</span></a></li>
